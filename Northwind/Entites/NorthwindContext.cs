...
namespace Northwind.Entites
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<PracownicyWa> PracownicyWas { get; set; } = null!;
        ...
        public virtual DbSet<Produkty> Produkties { get; set; } = null!;
        ...
        public virtual DbSet<WartoscSprzedazy> WartoscSprzedazies { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PracownicyWa>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Pracownicy_WA");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.Kategoria).HasMaxLength(20);
            ...
            modelBuilder.Entity<WartoscSprzedazy>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("Wartosc_sprzedazy");
